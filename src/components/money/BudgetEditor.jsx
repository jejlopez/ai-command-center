  ...
  return (
    <div className="glass p-5">
      <div className="flex items-center justify-between mb-3">
        <div className="label text-jarvis-cyan">Daily Budget</div>
        {saved && (
      ...
      {loading ? (
        ...
        <form onSubmit={save} className="flex items-center gap-2">
          <div className="flex-1 flex items-center gap-2 bg-jarvis-panel/40 border border-jarvis-border rounded-xl px-3 py-2">
          ...
          <button
            type="submit"
            disabled={busy}
            className="flex items-center gap-1.5 px-3 py-2 rounded-xl text-xs font-semibold bg-jarvis-cyan/10 text-jarvis-cyan border border-jarvis-cyan/30 hover:bg-jarvis-cyan/20 disabled:opacity-40 transition"
          >
