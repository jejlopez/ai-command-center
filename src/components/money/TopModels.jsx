...
export default function TopModels({ topModels = [] }) {
 ...
 <div
 key={`${r.model}-${i}`}
 className="rounded-xl bg-jarvis-surface/30 border border-jarvis-border px-3 py-2.5"
 >
 ...
 <span className="chip text-jarvis-primary border-jarvis-primary/30 bg-jarvis-primary/5 tabular-nums">
