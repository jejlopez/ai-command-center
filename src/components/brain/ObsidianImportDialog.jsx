...
export default function ObsidianImportDialog({ open, onClose, onCompleted }) {
 ...
 <div className="surface w-full max-w-lg p-6 relative">
 <button
 type="button"
 onClick={handleClose}
 disabled={busy}
 ...
 <FolderInput size={14} className="text-jarvis-primary" />
 <div className="label text-jarvis-primary">Import</div>
 </div>
 ...
 className="mt-1 w-full bg-jarvis-surface/40 border border-jarvis-border rounded-xl px-3 py-2 text-sm text-jarvis-ink focus:border-jarvis-primary/50 outline-none font-mono"
 autoFocus
 />
 </div>
 ...
 <span className="text-[11px] text-jarvis-primary tabular-nums">{defaultTrust.toFixed(2)}</span>
 </div>
 <input
 type="range"
 min={0}
 ...
 <div className="rounded-xl bg-jarvis-surface/40 border border-jarvis-border px-3 py-3 text-center">
 ...
 type="button"
 onClick={handleClose}
 className="px-4 py-2 rounded-xl text-sm font-semibold bg-jarvis-primary/10 text-jarvis-primary border border-jarvis-primary/30 hover:bg-jarvis-primary/20 transition"
 >
 Close
 </button>
 </div>
