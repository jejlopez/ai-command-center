...
export function VaultLockedOverlay({ onUnlocked }) {
 ...
 <div className="surface max-w-md w-[92%] p-8 text-center relative overflow-hidden">
 <div className="absolute -top-24 left-1/2 -translate-x-1/2 w-[420px] h-[420px] rounded-full bg-jarvis-primary/5 blur-[120px] pointer-events-none" />
 ...
 onClick={unlock}
 disabled={busy}
 className="mt-2 px-5 py-2.5 rounded-xl bg-jarvis-primary/15 text-jarvis-primary hover:bg-jarvis-primary/25 text-sm font-semibold flex items-center gap-2 disabled:opacity-60"
 >
