      ...
      <div className="space-y-5 max-w-md">
        <div className="relative">
          ...
          <input
            ...
            className="w-full rounded-xl bg-black/40 border border-jarvis-border pl-9 pr-4 py-3 text-2xl font-display text-jarvis-ink outline-none focus:border-jarvis-cyan/50"
          />
