...
export function LocalStep({ stepIndex, totalSteps, onNext, onBack }) {
 ...
 up ? "bg-jarvis-green/15" : "bg-white/5",
 ].join(" ")}>
 ...
 <code className="text-jarvis-primary">ollama pull llama3.1</code> and rescan.
 </div>
 )}
 {!up && (
 <div className="mt-4 text-[11px] text-jarvis-muted leading-relaxed">
 Ollama isn't running. Install from{" "}
 <span className="text-jarvis-primary">ollama.ai</span> and start the daemon — or skip this step.
 </div>
 )}
 </div>
 </div>
