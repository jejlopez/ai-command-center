...
export function VaultStep({ stepIndex, totalSteps, onNext }) {
 ...
 <code className="text-jarvis-primary">jarvisd.vault</code>. macOS will prompt for your login password the first time.
 </div>
 </div>
 </div>

 <div className="flex items-start gap-3 text-[11px] text-jarvis-muted">
 <KeyRound size={14} className="mt-0.5 text-jarvis-primary/70" />
 <div>
