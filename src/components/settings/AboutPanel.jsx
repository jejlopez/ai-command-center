  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
        {/* Daemon */}
        <Card icon={Activity} iconColor="text-jarvis-cyan bg-jarvis-cyan/15" glowClass="shadow-glow-cyan" title="Daemon" subtitle="jarvisd">
        ...
        <Card
          ...
          glowClass={auditOk ? "shadow-glow-green" : "shadow-glow-amber"}
          title="Audit Log"
        ...
        {/* Providers + Memory */}
        <Card icon={Cpu} iconColor="text-jarvis-blue bg-jarvis-blue/15" glowClass="" title="Intelligence" subtitle="Models + memory">
          <dl className="space-y-0.5">
