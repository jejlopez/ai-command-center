          ...
          return (
            <button
              ...
              className={[
                ...
                on
                  ? "border-jarvis-cyan/40 bg-jarvis-cyan/5 shadow-glow-cyan"
            ...
            >
              <div className="flex items-start justify-between gap-3">
                <div className="flex items-start gap-3">
                  <div className={[
                    ...
                    on ? "bg-jarvis-cyan/15 text-jarvis-cyan" : "bg-white/5 text-jarvis-body",
                  ].join(" ")}>
                    <Icon size={18} />
                  </div>
                  <div>
                ...
                <div className={[
                  ...
                  on ? "bg-jarvis-cyan/70" : "bg-white/10",
                ].join(" ")}>
                  <div
                    className={[
              ...
              {on && (
                <div className="mt-3 flex items-center gap-1.5 text-[11px] text-jarvis-cyan">
