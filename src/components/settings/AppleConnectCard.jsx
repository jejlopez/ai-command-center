...
export function AppleConnectCard() {
  ...
  return (
    <div className="rounded-2xl border border-jarvis-cyan/30 bg-gradient-to-b from-jarvis-cyan/[0.05] to-transparent p-5 relative overflow-hidden">
      <div className="absolute -top-16 left-1/2 -translate-x-1/2 w-[500px] h-[200px] rounded-full bg-jarvis-cyan/10 blur-[80px] pointer-events-none" />

      <div className="relative flex items-start justify-between gap-3 mb-4">
        <div>
          <div className="flex items-center gap-2">
            <span className="label text-jarvis-cyan">Recommended · zero setup</span>
          </div>
      ...
      {!anyOk ? (
        <button
          onClick={connect}
          disabled={busy}
          className="relative w-full py-2.5 rounded-xl bg-jarvis-cyan/15 text-jarvis-cyan hover:bg-jarvis-cyan/25 shadow-glow-cyan text-[13px] font-semibold transition flex items-center justify-center gap-2 disabled:opacity-60"
        >
