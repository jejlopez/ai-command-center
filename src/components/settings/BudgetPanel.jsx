...
export function BudgetPanel() {
 ...
 className="w-full rounded-xl bg-black/40 border border-jarvis-border pl-9 pr-4 py-3 text-xl font-display text-jarvis-ink outline-none focus:border-jarvis-primary/50"
 />
 </div>
 ...
 className="mt-2 w-full rounded-xl bg-black/40 border border-jarvis-border px-3 py-2.5 text-sm text-jarvis-ink outline-none focus:border-jarvis-primary/50"
 >
 {CURRENCIES.map((c) => (
 <option key={c} value={c} className="bg-jarvis-surface">{c}</option>
 ))}
 </select>
 </div>
 ...
 className="mt-2 w-full rounded-xl bg-black/40 border border-jarvis-border px-3 py-2.5 text-sm text-jarvis-ink placeholder:text-jarvis-muted outline-none focus:border-jarvis-primary/50 font-mono"
 />
