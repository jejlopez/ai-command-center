...
function Pill({ status, lastError }) {
  ...
  if (status === "linked") {
    return <span className="chip bg-jarvis-amber/10 text-jarvis-amber shadow-glow-amber">Linked</span>;
  }
  if (status === "error") {
    return (
      <span
        className="chip bg-jarvis-red/10 text-jarvis-red shadow-glow-red"
    ...
    <div className="rounded-2xl border border-jarvis-border bg-white/[0.02] p-4 flex flex-col gap-3">
      <div className="flex items-center justify-between gap-3">
        <div className="flex items-center gap-2.5">
          <div className="grid place-items-center w-8 h-8 rounded-xl bg-jarvis-cyan/10 text-jarvis-cyan">
        ...
        <div className="flex flex-col gap-2">
          <div>
            ...
            <input
              ...
              className="w-full rounded-xl bg-black/40 border border-jarvis-border px-3 py-2 text-sm text-jarvis-ink placeholder:text-jarvis-muted outline-none focus:border-jarvis-cyan/50"
            />
          </div>
          <div>
          ...
          {polling && (
            <div className="text-[11px] text-jarvis-cyan flex items-center gap-1.5">
      ...
      <div className="rounded-xl border border-jarvis-border/60 bg-black/30 px-3 py-2 text-[11px] text-jarvis-muted flex items-center gap-2">
        ...
        <code className="text-jarvis-cyan truncate">{redirectUri}</code>
        <button
          type="button"
          onClick={copyRedirect}
          title="Copy"
          className="ml-auto text-jarvis-muted hover:text-jarvis-cyan shrink-0"
        >
          <Copy size={12} />
        </button>
      </div>
      ...
      <button
        ...
        className="flex items-center gap-1 text-[11px] text-jarvis-muted hover:text-jarvis-cyan self-start"
      >
