...
export function VaultPanel() {
 ...
 Every secret lives in the macOS Keychain under <code className="text-jarvis-primary">jarvisd.vault</code>.
 </p>
 </div>
 <button
 type="button"
 ...
 <div className="w-10 h-10 rounded-full bg-jarvis-amber/15 grid place-items-center">
 ...
 onClick={unlock}
 disabled={busy}
 className="px-4 py-2 rounded-xl text-xs font-semibold bg-jarvis-primary/15 text-jarvis-primary hover:bg-jarvis-primary/25 transition"
 >
 Unlock vault
 </button>
 )}
 ...
 className="text-jarvis-muted hover:text-jarvis-primary"
 >
