...
export function GoogleSignInButton({ onLinked }) {
  ...
  return (
    <div className="rounded-xl border border-jarvis-cyan/20 bg-jarvis-cyan/5 p-3">
      {!open ? (
        <button
          onClick={() => setOpen(true)}
          className="w-full py-2 px-3 rounded-lg bg-jarvis-cyan/15 text-jarvis-cyan hover:bg-jarvis-cyan/25 text-[12px] font-semibold transition flex items-center justify-center gap-2"
        >
        ...
        <div className="space-y-3">
          <div className="flex items-center justify-between">
            <span className="label text-jarvis-cyan">Google OAuth — one-time setup</span>
            <button
          ...
          <button
            ...
            className="w-full py-2 px-3 rounded-lg bg-jarvis-cyan/15 text-jarvis-cyan hover:bg-jarvis-cyan/25 text-[12px] font-semibold transition flex items-center justify-center gap-2 disabled:opacity-50"
          >
