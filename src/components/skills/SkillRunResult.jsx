...
export default function SkillRunResult({ run }) {
 ...
 return (
 <pre className="text-[11px] text-jarvis-body bg-jarvis-surface/40 border border-jarvis-border rounded-xl p-3 overflow-auto max-h-[400px] whitespace-pre-wrap">
