...
export default function NodeList({ nodes = [], onForget, onClick, emptyLabel = "Nothing yet", forgettingId = null }) {
 ...
 return (
 <div className="surface p-5 text-[12px] text-jarvis-muted italic text-center">
 {emptyLabel}
 </div>
 );
 }
 ...
 key={n.id}
 className={[
 "surface p-3 flex items-start gap-3 group",
 clickable ? "cursor-pointer hover:bg-white/5" : "",
 ].join(" ")}
 onClick={clickable ? () => onClick(n) : undefined}
 >
 <span className="chip text-jarvis-primary border-jarvis-primary/30 bg-jarvis-primary/5 shrink-0">
 {n.kind}
 </span>
