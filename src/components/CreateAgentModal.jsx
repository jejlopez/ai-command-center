        ...
        <button
          ...
          className={cn(
            ...
            value === option.value
              ...
              : 'border-hairline bg-panel-soft text-text-body hover:bg-panel hover:text-text-primary'
          )}
        >
          {option.label}
        </button>
          ...
          >
            <div className="border-b border-hairline px-6 py-5">
              <div className="flex items-center justify-between gap-4">
                ...
                <button onClick={onClose} className="ui-button-secondary rounded-lg p-2 text-text-body transition-colors hover:bg-panel-soft hover:text-text-primary">
                  <X className="h-5 w-5" />
                </button>
              </div>
            </div>
            ...
            <form onSubmit={handleSubmit} className="flex-1 overflow-y-auto px-6 py-5 space-y-6 no-scrollbar">
              <div className="rounded-[1.4rem] border border-hairline bg-panel-soft p-4 shadow-sm">
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full rounded-2xl border border-hairline bg-panel-soft px-4 py-3 text-sm font-mono text-text-primary placeholder:text-text-disabled outline-none transition-colors focus:border-aurora-teal/40"
                      autoFocus
                    />
                  </div>
                        ...
                        <button
                          ...
                          className={cn(
                            ...
                            form.role === role.id
                              ...
                              : 'border-hairline bg-panel-soft hover:border-hairline-strong'
                          )}
                        >
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      rows={2}
                      className="w-full resize-none rounded-2xl border border-hairline bg-panel-soft px-4 py-3 text-sm leading-6 text-text-primary placeholder:text-text-disabled outline-none transition-colors focus:border-aurora-teal/40"
              ...
              >
                <div className="space-y-4">
                  <div className="rounded-2xl border border-hairline bg-panel-soft px-4 py-3">
                  ...
                  {models.length > 0 ? (
                    <div className="space-y-2">
                      ...
                      {visibleModels.length === 0 && (
                        <div className="rounded-2xl border border-hairline ui-well p-3 text-xs text-text-body">
                          No models saved for this provider yet.
                        </div>
                      )}
                    </div>
                  ) : (
                    <div className="rounded-2xl border border-hairline ui-well p-4 text-xs text-text-body">
                      No models in your bank yet. Add one below to make it available here.
                    </div>
                  )}

                  <div className="rounded-2xl border border-hairline ui-well p-4 space-y-3">
                    ...
                    <input
                      ...
                      className="w-full rounded-xl border border-hairline-strong bg-panel px-3 py-2 text-xs font-mono text-text-primary outline-none focus:border-aurora-teal/40"
                    />
                    <div className="grid grid-cols-2 gap-2">
                      <input
                        type="text"
                        ...
                        className="w-full rounded-xl border border-hairline-strong bg-panel px-3 py-2 text-xs text-text-primary outline-none focus:border-aurora-teal/40"
                      />
                      <input
                        type="number"
                        min="0"
              ...
              >
                <div className="space-y-4">
                  ...
                  <div className="flex items-center justify-between rounded-2xl border border-hairline bg-panel-soft px-4 py-3">
                    <div>
                    ...
                    <button
                      ...
                      className={cn(
                        ...
                        form.canSpawn ? 'bg-aurora-teal' : 'ui-well'
                      )}
                    >
                      <motion.div
            ...
            <div className="border-t border-hairline px-6 py-4">
              <div className="flex items-center gap-3">
                <button
                  type="button"
                  onClick={onClose}
                  className="flex-1 rounded-xl border border-hairline py-3 text-xs font-medium text-text-dim transition-all hover:bg-panel-soft hover:text-text-primary"
                >
                  Cancel
                </button>
                <button
