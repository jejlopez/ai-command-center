  ...
  return (
    <div className="flex items-center gap-2">
      <button
        ...
        className="p-1 rounded hover:bg-jarvis-cyan/10 text-jarvis-muted hover:text-jarvis-green transition-colors"
        title="Good result"
      >
        <ThumbsUp size={14} />
      </button>
      <button
        ...
        className="p-1 rounded hover:bg-jarvis-cyan/10 text-jarvis-muted hover:text-jarvis-red transition-colors"
        title="Bad result"
      >
        <ThumbsDown size={14} />
      </button>
      <button
        ...
        className="p-1 rounded hover:bg-jarvis-cyan/10 text-jarvis-muted hover:text-jarvis-cyan transition-colors"
        title="Add reason"
      >
      ...
      {showReason && (
        <input
          ...
          placeholder="Why?"
          className="bg-jarvis-panel border border-jarvis-border rounded px-2 py-0.5 text-xs text-jarvis-ink w-40"
          autoFocus
        />
      )}
    </div>
...
export function WhyThisDrawer({ runId }) {
  ...
  return (
    <div>
      ...
      {open && (
        <div className="mt-2 p-3 rounded-lg bg-jarvis-panel border border-jarvis-border text-xs">
          {loading ? (
            ...
            <div className="space-y-1">
              ...
              {explanation.learned && (
                <div className="text-jarvis-cyan">
